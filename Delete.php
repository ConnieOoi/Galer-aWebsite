...
<?php
 ...
 ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="section-heading text-white">DELETE</h2>
	...
	<div class = "main" align="center">
			...
			<form action="DeleteFunction.php" method="POST" enctype="multipart/form-data" >

				<table style="align:center; margin-top: 20px">
					<tr>
						<th>Enter the image caption you wish to delete!</th>
						<th><br><br></th> 
					</tr>
					<br>
					<tr>
						<th>Caption : </th>
						<td><input type="text" id="Caption" name="Caption" text-align:"center" required="required"></td>
					</tr>
				</table> 
					<br>
					<br>
